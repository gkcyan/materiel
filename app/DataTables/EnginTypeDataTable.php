...
class EnginTypeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'engin_types.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\EnginType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(EnginType $model)
    {
    ...
    {
        return [
            'type' => new Column(['title' => __('models/engin_types.fields.type'), 'data' => 'type']),
            'code' => new Column(['title' => __('models/engin_types.fields.code'), 'data' => 'code']),
            'statut' => new Column(['title' => __('models/engin_types.fields.statut'), 'data' => 'statut'])
        ];
    }
