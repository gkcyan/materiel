...
class CategorieDataTable extends DataTable
{
    ...
    {
        return [
            'categorie' => new Column(['title' => __('models/categories.fields.categorie'), 'data' => 'categorie']),
            'description' => new Column(['title' => __('models/categories.fields.description'), 'data' => 'description']),
            'statut' => new Column(['title' => __('models/categories.fields.statut'), 'data' => 'statut']),
            'code_prodtui' => new Column(['title' => __('models/categories.fields.code_prodtui'), 'data' => 'code_prodtui'])
        ];
    }
