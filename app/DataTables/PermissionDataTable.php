...
class PermissionDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'slug' => new Column(['title' => __('models/permissions.fields.slug'), 'data' => 'slug']),
            'description' => new Column(['title' => __('models/permissions.fields.description'), 'data' => 'description']),
            'model' => new Column(['title' => __('models/permissions.fields.model'), 'data' => 'model'])
        ];
    }
