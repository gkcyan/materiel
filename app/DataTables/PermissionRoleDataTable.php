...
class PermissionRoleDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'permission_roles.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\PermissionRole $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PermissionRole $model)
    {
    ...
    {
        return [
            'permission_id' => new Column(['title' => __('models/permission_role.fields.permission_id'), 'data' => 'permission_id']),
            'role_id' => new Column(['title' => __('models/permission_role.fields.role_id'), 'data' => 'role_id'])
        ];
    }
