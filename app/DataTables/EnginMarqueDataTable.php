...
class EnginMarqueDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'engin_marques.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\EnginMarque $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(EnginMarque $model)
    {
    ...
    {
        return [
            'marque' => new Column(['title' => __('models/engin_marques.fields.marque'), 'data' => 'marque']),
            'code' => new Column(['title' => __('models/engin_marques.fields.code'), 'data' => 'code']),
            'statut' => new Column(['title' => __('models/engin_marques.fields.statut'), 'data' => 'statut'])
        ];
    }
