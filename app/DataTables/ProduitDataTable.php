...
class ProduitDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'produits.datatables_actions');
    }
    ...
    {
        return [
            'produit' => new Column(['title' => __('models/produits.fields.produit'), 'data' => 'produit']),
            'description' => new Column(['title' => __('models/produits.fields.description'), 'data' => 'description']),
            'categorie_id' => new Column(['title' => __('models/produits.fields.categorie_id'), 'data' => 'categorie_id']),
            'code' => new Column(['title' => __('models/produits.fields.code'), 'data' => 'code']),
            'statut' => new Column(['title' => __('models/produits.fields.statut'), 'data' => 'statut'])
        ];
    }
