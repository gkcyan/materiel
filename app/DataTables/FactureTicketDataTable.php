...
class FactureTicketDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'facture_tickets.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\FactureTicket $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FactureTicket $model)
    {
    ...
    {
        return [
            'facture_id' => new Column(['title' => __('models/facture_tickets.fields.facture_id'), 'data' => 'facture_id']),
            'ticket_id' => new Column(['title' => __('models/facture_tickets.fields.ticket_id'), 'data' => 'ticket_id'])
        ];
    }
