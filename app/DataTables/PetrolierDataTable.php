...
class PetrolierDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'petroliers.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Petrolier $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Petrolier $model)
    {
    ...
    {
        return [
            'petrolier' => new Column(['title' => __('models/petroliers.fields.petrolier'), 'data' => 'petrolier'])
        ];
    }
