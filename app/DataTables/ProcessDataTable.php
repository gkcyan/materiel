...
class ProcessDataTable extends DataTable
{
    ...
    {
        return [
            'processus' => new Column(['title' => __('models/processes.fields.processus'), 'data' => 'processus']),
            'finalite' => new Column(['title' => __('models/processes.fields.finalite'), 'data' => 'finalite']),
            'pilote' => new Column(['title' => __('models/processes.fields.pilote'), 'data' => 'pilote']),
            'controleur' => new Column(['title' => __('models/processes.fields.controleur'), 'data' => 'controleur']),
            'code' => new Column(['title' => __('models/processes.fields.code'), 'data' => 'code']),
            'autor_creat' => new Column(['title' => __('models/processes.fields.autor_creat'), 'data' => 'autor_creat']),
            'autor_update' => new Column(['title' => __('models/processes.fields.autor_update'), 'data' => 'autor_update'])
        ];
    }
