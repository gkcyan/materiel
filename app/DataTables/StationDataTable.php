...
class StationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'stations.datatables_actions');
    }
    ...
    {
        return [
            'station' => new Column(['title' => __('models/stations.fields.station'), 'data' => 'station']),
            'petrolier_id' => new Column(['title' => __('models/stations.fields.petrolier_id'), 'data' => 'petrolier_id'])
        ];
    }
