...
class RoleDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'slug' => new Column(['title' => __('models/roles.fields.slug'), 'data' => 'slug']),
            'description' => new Column(['title' => __('models/roles.fields.description'), 'data' => 'description']),
            'level' => new Column(['title' => __('models/roles.fields.level'), 'data' => 'level'])
        ];
    }
