...
class PermissionUserDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'permission_users.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\PermissionUser $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PermissionUser $model)
    {
    ...
    {
        return [
            'permission_id' => new Column(['title' => __('models/permission_user.fields.permission_id'), 'data' => 'permission_id']),
            'user_id' => new Column(['title' => __('models/permission_user.fields.user_id'), 'data' => 'user_id'])
        ];
    }
